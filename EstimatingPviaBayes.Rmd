...
nreps<-20
ntrials<-50
mydata<-rbinom(n=nreps,size=ntrials,prob=rep(c(0.5,0.99),times=c(2,18)))
myps<-mydata/ntrials
hist(myps)
```

In this case, a standard binomial 95% CI will lead to inadmissible results
...
However, in a bayesian setting, than canot happen. Check it out.
